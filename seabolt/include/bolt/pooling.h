...
PUBLIC struct BoltConnectionPool * BoltConnectionPool_create(
        enum BoltTransport transport, const char * host, const char * port,
        const char * user_agent, const char * user, const char * password, size_t size);
